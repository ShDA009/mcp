...
| `find_free_slots` | `target_date: str (YYYY-MM-DD)`, `duration_min: int`, `emails?: list[str]` | Свободные окна нужной длительности в рабочие часы дня (рабочие часы читаются из настроек Exchange через `GetUserAvailability`). Если передан `emails`, ищутся окна, свободные одновременно у своего ящика и у всех указанных коллег; рабочие часы всегда берутся из своего ящика |
